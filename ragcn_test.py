...
from features.utils import get_configs
from features.SP_Pooling import I3D_Pooling
from tqdm import tqdm
import random

parser = argparse.ArgumentParser(
    description="PGCN Testing Tool")
parser.add_argument('dataset', type=str, choices=['activitynet1.2', 'samm'])
...
parser.add_argument('-j', '--workers', default=4, type=int, metavar='N',
                    help='number of data_info loading workers (default: 4)')
