...
class LOSO_DATASET(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        data = np.load(feat_file_path)# data_info["feature","label","vedio_name"]
        feature = data['feature']  # (270, 12, 2)

        # img1 = Image.fromarray(feature, mode="RGB")
        # imshow(img1)
        # plt.show()
        #
        # feature1 = np.transpose(feature,(1,2,0))
        # img1 = Image.fromarray(feature1,mode="RGB")
        # imshow(img1)
        # plt.show()
        #
        # feature1 = np.transpose(feature, (2, 1, 0))
        # img1 = Image.fromarray(feature1, mode="RGB")
        # imshow(img1)
        # plt.show()
