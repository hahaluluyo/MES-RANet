...
def compute_average_precision_classification(ground_truth, prediction):
    ...
    predictions data_info frames. If multiple predictions occurs for the same
...
def compute_video_hit_at_k(ground_truth, prediction, top_k=3, avg=False):
    ...
    predictions data_info frames. This code is greatly inspired by evaluation
