...
def get_configs(dataset):
    data = yaml.load(open('data_info/dataset_cfg.yaml', 'r'), Loader=yaml.RoundTripLoader)
    return data[dataset]
...
def get_and_save_args(parser):
    ...
    default_config = yaml.load(open('./data_info/dataset_cfg.yaml', 'r'), Loader=yaml.RoundTripLoader)[dataset]
